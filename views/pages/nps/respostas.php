<section class="space-y-6">
  <div class="flex justify-between items-center mb-6">
    ...
    <div class="flex items-center space-x-3">
      <a href="/nps/<?= e($formulario['id']) ?>/exportar-excel" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors">
