  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div class="space-y-3">
        <div class="flex justify-between items-center">
          ...
          <span class="text-sm font-medium text-gray-900"><?= e($systemVersion) ?></span>
        </div>
        <div class="flex justify-between items-center">
          <span class="text-sm text-gray-600">Última Atualização:</span>
          <span class="text-sm font-medium text-gray-900"><?= e($lastUpdate) ?></span>
        </div>
        <div class="flex justify-between items-center">
          <span class="text-sm text-gray-600">Ambiente:</span>
          <span class="text-sm font-medium text-green-600">
            <?= e($_ENV['APP_ENV'] ?? 'production') === 'production' ? 'Produção' : 'Desenvolvimento' ?>
          </span>
        </div>
        <div class="flex justify-between items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div class="flex items-center mb-4">
        ...
        <h3 class="text-lg font-semibold text-gray-900">Acesso Rápido</h3>
      </div>
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="text-center p-3 bg-gray-50 rounded-lg">
          ...
          <div class="text-xs text-gray-600">Perfis</div>
        </div>
        <div class="text-center p-3 bg-gray-50 rounded-lg">
        ...
        <div class="text-center p-3 bg-gray-50 rounded-lg">
          ...
          <div class="text-xs text-gray-600">Seguro</div>
        </div>
      </div>
    </div>
  </div>
