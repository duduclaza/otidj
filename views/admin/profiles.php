...
const modules = [
  ...
  { key: 'solicitacao_melhorias', name: '→ Solicitação de Melhorias' },
  { key: 'melhorias_pendentes', name: '→ Melhorias Pendentes' },
  { key: 'historico_melhorias', name: '→ Histórico de Melhorias' },
