...
$menu = [
  ...
  [
    ...
    'icon' => '📊', 
    'category' => true,
    'modules' => ['homologacoes', 'femea', 'pops_its', 'fluxogramas', 'melhoria_continua', 'solicitacao_melhorias', 'melhorias_pendentes', 'historico_melhorias', 'controle_rc'],
    'submenu' => [
      ...
      ['label' => 'Melhorias Pendentes', 'href' => '/melhoria-continua/pendentes', 'icon' => '⏳', 'module' => 'melhorias_pendentes'],
      ['label' => 'Histórico de Melhorias', 'href' => '/melhoria-continua/historico', 'icon' => '🕘', 'module' => 'historico_melhorias'],
