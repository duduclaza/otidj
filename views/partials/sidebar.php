...
<aside id="sidebar" class="hidden lg:flex lg:w-72 flex-col bg-slate-800 border-r border-slate-700">
  ...
  <nav class="flex-1 overflow-y-auto py-4 sidebar-scroll">
    <ul class="space-y-1 px-3">
      ...
      <li>
        <a href="/dashboard-manutencao" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-slate-700 <?php echo $current==='/dashboard-manutencao'?'bg-blue-600 text-white shadow-lg':'text-slate-300 hover:text-white'; ?>">
          <span class="text-lg">📊</span>
          <span>Dashboard</span>
        </a>
      </li>
...
<div class="lg:hidden">
  ...
  <div id="mobileDrawer" class="hidden fixed inset-y-0 left-0 w-72 bg-slate-800 z-50 shadow-lg">
    ...
    <nav class="p-3 space-y-1">
      <?php if (hasPermission('dashboard')): ?>
      <a href="/dashboard-manutencao" class="page-link block px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-700 hover:text-white transition-all duration-200">Dashboard</a>
      <?php endif; ?>
