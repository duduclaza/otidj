-- ==========================================
-- MIGRATION: Módulo de Homologações
-- Data: 2024-10-16
-- Descrição: Cria estrutura completa do módulo de homologações (Kanban)
-- ==========================================

-- 1. VERIFICAR E ADICIONAR COLUNA DEPARTMENT (se não existir)
-- Necessária para identificar departamento Compras e Logística
...
-- 6. INSERIR PERMISSÕES PADRÃO PARA PERFIS
-- Por padrão, apenas Administrador e Super Admin têm acesso completo
...
SELECT 
    CASE 
        ...
        ELSE '⚠️ Nenhuma permissão configurada'
    END as Permissoes
FROM profile_permissions 
WHERE module = 'homologacoes';

SELECT '🎉 Migration concluída! Acesse: /homologacoes' as 'Próximo Passo';
